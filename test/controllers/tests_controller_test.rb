...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { group_id: @test.group_id, name: @test.name, subject_id: @test.subject_id } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { group_id: @test.group_id, name: @test.name, subject_id: @test.subject_id } }
