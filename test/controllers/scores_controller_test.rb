...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { score: @score.score, student_id: @score.student_id, test_id: @score.test_id } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { score: @score.score, student_id: @score.student_id, test_id: @score.test_id } }
