...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { day: @period.day, state: @period.state, student_id: @period.student_id, week_id: @period.week_id } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { day: @period.day, state: @period.state, student_id: @period.student_id, week_id: @period.week_id } }
